...
## 🛠️ Current Learning Path (2026-2027)

- [x] **Clinical Expertise:** 3+ years of experience in CT, MRI, and PET imaging.
- [ ] **Programming:** Mastering Python, Pydicom, and Matplotlib for medical data.
- [ ] **Language:** Proactively learning Korean (Duolingo & TOPIK prep).

## 📁 Repository Overview
- `Radiology-Analysis/`: Python scripts to extract radiation dose from DICOM headers.
- `Deep-Learning-Basics/`: My progress in CNN architectures for medical imaging.
- `Clinical-Physics/`: Mathematical simulations of radioactive decay and dosimetry.
---
"Bridging technological gaps in healthcare through science and resilience." 🌍✨
